...
export const PRODUCTS_FILTERS: Array<ProductFilter> = [
    ...
    },
    {
        ...
        filters: [
            ...
            // { id: 212, name: CATEGORY.PROMATE, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.PROMATE, count: 0 },
            // { id: 213, name: CATEGORY.RIVACASE, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.RIVACASE, count: 0 },
            // { id: 214, name: CATEGORY.SAMSONITE, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.SAMSONITE, count: 0 },
            // { id: 215, name: CATEGORY.SAMSUNG, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.SAMSUNG, count: 0 },
            // { id: 216, name: CATEGORY.SANDISK, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.SANDISK, count: 0 },
            // { id: 217, name: CATEGORY.SEAGATE, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.SEAGATE, count: 0 },
            // { id: 218, name: CATEGORY.TUMI, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.TUMI, count: 0 },
            // { id: 219, name: CATEGORY.WD, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.WD, count: 0 },
            // { id: 220, name: CATEGORY.XTORM, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.XTORM, count: 0 },
        ]
    },
    {
