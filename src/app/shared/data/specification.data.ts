...
export const SUBTITLES: Array<string> = [
    SPECIFICATIONS.DISPLAY_DIAGONAL,
    SPECIFICATIONS.DISPLAY_RESOLUTION,
    SPECIFICATIONS.DISPLAY_FREQUENCY,
    SPECIFICATIONS.DISPLAY_TOUCH,
]
