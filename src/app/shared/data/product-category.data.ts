...
export const PRODUCTS_FILTERS: Array<ProductFilter> = [
    ...
    },
    {
        ...
        filters: [
            ...
            { id: 203, name: CATEGORY.APPLE, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.APPLE, count: 0 },
            { id: 204, name: CATEGORY.ASUS, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.ASUS, count: 0 },
            { id: 205, name: CATEGORY.DELL, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.DELL, count: 0 },
            { id: 206, name: CATEGORY.HAMA, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.HAMA, count: 0 },
            { id: 207, name: CATEGORY.HP, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.HP, count: 0 },                        
            { id: 208, name: CATEGORY.KINGSTON, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.KINGSTON, count: 0 },
            { id: 209, name: CATEGORY.LENOVO, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.LENOVO, count: 0 },
            { id: 210, name: CATEGORY.MSI, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.MSI, count: 0 },
            { id: 211, name: CATEGORY.MYRIA, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.MYRIA, count: 0 },
            { id: 212, name: CATEGORY.PHILIPS, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.PHILIPS, count: 0 },
            ...
            { id: 219, name: CATEGORY.WD, value: CATEGORY.BRAND, isChecked: false, min: 0, max: 0, labelName: CATEGORY.WD, count: 0 },
        ]
    },
    {
        name: "Subcategorie",
        ...
        filters: [
            ...
            { id: 402, name: CATEGORY.SLEEVE, value: CATEGORY.SUBCATEGORY, isChecked: false, min: 0, max: 0, labelName: CATEGORY.SLEEVE, count: 0 },
            { id: 403, name: CATEGORY.BACKPACK, value: CATEGORY.SUBCATEGORY, isChecked: false, min: 0, max: 0, labelName: CATEGORY.BACKPACK, count: 0 },

            { id: 404, name: CATEGORY.PLUG_IN, value: CATEGORY.SUBCATEGORY, isChecked: false, min: 0, max: 0, labelName: CATEGORY.PLUG_IN, count: 0 },
            { id: 405, name: CATEGORY.CAR, value: CATEGORY.SUBCATEGORY, isChecked: false, min: 0, max: 0, labelName: CATEGORY.CAR, count: 0 },

            { id: 406, name: CATEGORY.HDD, value: CATEGORY.SUBCATEGORY, isChecked: false, min: 0, max: 0, labelName: CATEGORY.HDD, count: 0 },
            { id: 407, name: CATEGORY.SSD, value: CATEGORY.SUBCATEGORY, isChecked: false, min: 0, max: 0, labelName: CATEGORY.SSD, count: 0 },
        ]
    },
]
