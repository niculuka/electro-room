...
export class LaptopBagComponent implements OnInit {
  ...
  protected laptopBags_copy: Array<Product> = [];
  ...
  protected bag: Array<Product> = [];
  protected bag_out: Array<Product> = [];

  sleeve_chk: boolean = false;
  protected sleeve: Array<Product> = [];
  protected sleeve_out: Array<Product> = [];

  backpack_chk: boolean = false;
  protected backpack: Array<Product> = [];
  protected backpack_out: Array<Product> = [];
  ...
  filter_promate() {
    ...
    if (this.promate_chk) {
      ...
      this.promate = new Array<Product>;
    }
    this.brands_check_and_concat();
  }
  ...
  filter_rivacase() {
    ...
    if (this.rivacase_chk) {
      ...
      this.rivacase = new Array<Product>;
    }
    this.brands_check_and_concat();
  }
  ...
  filter_samsonite() {
    ...
    if (this.samsonite_chk) {
      ...
      this.samsonite = new Array<Product>;
    }
    this.brands_check_and_concat();
  }
  ...
  get_promate() {
    this.brand = this.price;
    this.promate_out = new Array<Product>;
    this.brand.filter((res: any) => {
  ...
  get_rivacase() {
    this.brand = this.price;
    this.rivacase_out = new Array<Product>;
    this.brand.filter((res: any) => {
  ...
  get_samsonite() {
    this.brand = this.price;
    this.samsonite_out = new Array<Product>;
    this.brand.filter((res: any) => {
  ...
  filter_backpack() {
    ...
    if (this.backpack_chk) {
      ...
      this.backpack = new Array<Product>;
    }
    this.category_check_and_concat();
  }
  ...
  get_bag() {
    ...
    this.bag_out = new Array<Product>;
  ...
  get_sleeve() {
    this.category = this.brand;
    this.sleeve_out = new Array<Product>;
    this.category.filter((res: any) => {
  ...
  get_backpack() {
    this.category = this.brand;
    this.backpack_out = new Array<Product>;
    this.category.filter((res: any) => {
